...
def profile():
    if utils.authed():
        if request.method == "POST":
            ...
            if len(errors) > 0:
                return render_template('profile.html', name=name, country=country, errors=errors)
            else:
            ...
            return render_template('profile.html', name=name, website=website, affiliation=affiliation,
